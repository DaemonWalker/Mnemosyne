...
public static class LanguageRegistry
{
    ...
    [
        ...
        new("XML", "xml", ["xml", "xaml", "xsl", "xslt", "svg", "config", "csproj", "props", "targets", "resx", "settings", "nuspec", "slnx"], FormatterId: "xml"),
        new("HTML", "hypertext", ["html", "htm", "shtml", "xhtml", "vue", "cshtml", "razor"], FormatterId: "html"),
        new("CSS", "css", ["css", "scss", "less"]),
        new("JSON", "json", ["json", "jsonc", "json5", "ipynb"], FormatterId: "json"),
