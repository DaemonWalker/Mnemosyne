...
/// 例外：DataWeaveLexerName 不是 Lexilla 名称，ScintillaHost 对其使用 container lexer + Services.DataWeaveLexer 上色。
/// </summary>
public static class LanguageRegistry
{
    public const string DataWeaveLexerName = "dataweave";
    ...
    [
        ...
        // Lexilla（5.5.0）无 go/kotlin/swift/objectivec/groovy/scala 独立 Lexer，复用 cpp + 各自关键字表（同 C#/Java/JS/TS）
        ...
        new("CMake", "cmake", ["cmake"], KeywordsCmake, SupportsFolding: true),
        ...
        new("DataWeave", DataWeaveLexerName, ["dwl"]),
    ];
    ...
    // dart lexer 有四个关键字表（primary/secondary/tertiary/types），LanguageDefinition 只有两个槽位：
